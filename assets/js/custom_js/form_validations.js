...
$(document).ready(function () {
    ...
    // this is the second validation for patient
    ...
    $('#form-validation1').bootstrapValidator({
        ...
        $('#form-validation1').data('bootstrapValidator').resetForm();
    });

    // this is the third validation for appointment

    $('#form-validation4').bootstrapValidator({
        fields: {
            department: {
                validators: {
                    notEmpty: {
        ...
        $('#form-validation4').data('bootstrapValidator').resetForm();
    });
