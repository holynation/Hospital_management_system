   ...
   if (substr(trim($line), -1, 1) == ';'){
    ...
    $myfile = fopen("../application/config/database.php", "w") or die("Unable to open file!");
     ...
     $adminconfg = fopen("../application/config/config.php", "w") or die("Unable to open file!");
          ...
          $txt1 .='$config["index_page"] = "";'."\r\n";
          $txt1 .='$config["salt"] = "_$2y$12$7";'."\r\n";
          $txt1 .='$config["hot_email"] = "no-reply@holynationDevelopment@gmail.com";'."\r\n";
          ...
          $txt1 .='$config["cookie_name"]   = "hash";'."\r\n";
          $txt1 .='$config["cookie_expiry"]   = 86500;'."\r\n";
          ...
          $txt1 .='$config["seun_installer"] = TRUE;'."\r\n";
    ...
    $conn = mysqli_connect($db_host,$db_username,$db_password,$db_name) ;
      if($conn){
        $sql = "update settings set smtp_username='$smtp_username',smtp_host='$smtp_host',smtp_password='$smtp_password',email='$admin_email' where id='1' ";
         ...
         if($query){
          $file = "../INSTALLER_TRUE.php";
            if(file_exists($file)){
                echo "Success";
                rename('../INSTALLER_TRUE.php', '../INSTALLER_TRUE_DONE.php');
