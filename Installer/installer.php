...
<div class="container">
	<div class="bms-wizard-wrapper">
          ...
          <p style="font-weight: bolder;color: #428bca;font-size:25px;">E<b style="color:red;">H</b>M</p>
			</div>
    ...
    <div class="row setup-content" id="step-1">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input  maxlength="100" type="text" required="required" id="db_host" name="db_host" class="form-control chclr" placeholder="Database Host" value="<?php echo $_SERVER["HTTP_HOST"]; ?>"  />
          </div>
          <div class="form-group">
...
/*mycode*/
    ...
    if(curStepBtn=="step-4" && isValid==true){
     ...
     // var security_key=$('#security_key').val();
      ...
      var allVal='<div class="col-md-6 " style="padding:0px;"> <div class="all_dtl"><div class="all_dtl1">Database Host</div><div class="all_dtl2">:</div><div class="all_dtl3">'+db_host+'</div></div><div class="all_dtl"><div class="all_dtl1">Database Name</div><div class="all_dtl2">:</div><div class="all_dtl3">'+db_name+'</div></div><div class="all_dtl"><div class="all_dtl1">Database Username</div><div class="all_dtl2">:</div><div class="all_dtl3">'+db_username+'</div></div><div class="all_dtl"><div class="all_dtl1">Database Password</div><div class="all_dtl2">:</div><div class="all_dtl3">'+db_password+'</div></div><div class="all_dtl"><div class="all_dtl1">SMTP Host</div><div class="all_dtl2">:</div><div class="all_dtl3">'+smtp_host+'</div></div><div class="all_dtl"><div class="all_dtl1">SMTP USername</div><div class="all_dtl2">:</div><div class="all_dtl3">'+smtp_username+'</div></div></div><div class="col-md-6"><div class="all_dtl"><div class="all_dtl1">SMTP Password</div><div class="all_dtl2">:</div><div class="all_dtl3">'+smtp_password+'</div></div><div class="all_dtl"><div class="all_dtl1">Admin Email</div><div class="all_dtl2">:</div><div class="all_dtl3">'+admin_email+'</div></div><div class="all_dtl"></div></div>';
       $('.allData').html(allVal);
