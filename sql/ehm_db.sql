...
CREATE TABLE `appointment` (
  ...
  `category` enum('GC','ANC') NOT NULL DEFAULT 'GC',
...
INSERT INTO `appointment` (`id`, `patient_id`, `department`, `doctor_name`, `appointment_date`, `complaint`, `type`, `category`, `status`, `date_created`, `date_modified`) VALUES
(3, 2, '4', '1', '2018-03-05 09:00:00', 'Stomach ache and Head ache...', 'Schedule appointment', 'GC', 'false', '2018-02-27 16:15:28', '2018-02-28 00:42:43'),
(4, 3, '5', '2', '2018-02-28 00:27:05', 'Purging and a slight headache...', 'Walk in appointment', 'GC', 'true', '2018-02-28 00:27:05', '0000-00-00 00:00:00'),
(5, 9, '6', '6', '2018-03-09 09:00:00', 'Stomach and head ache...', 'Schedule appointment', 'GC', 'false', '2018-03-07 01:30:24', '2018-03-07 01:57:03'),
(6, 9, '6', '6', '2018-04-09 12:00:00', '', 'Schedule appointment', 'GC', 'false', '2018-04-09 12:48:15', '0000-00-00 00:00:00'),
(7, 5, '6', '6', '2018-04-11 16:47:43', '', 'Walk in appointment', 'GC', 'true', '2018-04-11 16:47:43', '0000-00-00 00:00:00'),
(8, 1, '6', '6', '2018-04-30 12:21:11', '', 'Schedule appointment', 'ANC', 'false', '2018-04-25 13:21:15', '0000-00-00 00:00:00'),
(9, 1, '6', '6', '2018-04-30 12:47:00', '', 'Schedule appointment', 'ANC', 'false', '2018-04-25 13:47:06', '0000-00-00 00:00:00');
...
CREATE TABLE `invoice_history` (
  `id` int(11) NOT NULL,
  `medicine_sold_id` int(11) DEFAULT NULL,
...
INSERT INTO `invoice_history` (`id`, `medicine_sold_id`, `date_created`) VALUES
(2, 11, '2018-04-10 10:37:55');
...
(1, 'Aspirin', 1, 'caps', '30ml', '2016-03-24 00:00:00', '', 'ggt', 24, '2018-03-30 00:00:00', 1000, 'pharmadeco', 800, '2018-03-19 18:16:18', '0000-00-00 00:00:00', ''),
(2, 'Dolometa-b', 5, 'caps', '500mg', '2018-03-14 00:00:00', 'No side effect', 'Pain killer', 38, '2020-03-25 00:00:00', 200, 'pharmadeco', 100, '2018-03-20 13:56:16', '2018-03-26 17:33:33', 'Admin Alatise Abraham'),
(3, 'Vitamin c', 1, 'caps', '800ml', '2018-03-02 00:00:00', '', 'Vitamin c', 7, '2018-03-10 00:00:00', 500, 'pharmadeco', 200, '2018-03-27 09:16:51', '0000-00-00 00:00:00', '');
...
INSERT INTO `medicine_sold` (`id`, `patient_id`, `medicine_id`, `quantity`, `discount`, `total`, `invoice_no`, `date_created`, `submitted_by`) VALUES
(1, 1, '1,2', '10,20', 400, 13600, 7612, '2018-03-26 17:25:03', 'Alatise Abraham'),
(2, 9, '1,2,3', '10,5,5', 200, 13300, 7613, '2018-03-28 11:38:45', ' Alatise Abraham'),
(3, 6, '2,3', '2,2', 0, 1400, 7614, '2018-04-03 10:15:11', ' Alatise Abraham'),
(4, 6, '1,2', '2,2', 0, 2400, 7615, '2018-04-03 10:20:43', ' Alatise Abraham'),
(5, 7, '1', '2', 0, 2000, 7616, '2018-04-03 14:20:51', ' Alatise Abraham'),
(8, 3, '3', '1', 0, 500, 7617, '2018-04-09 13:05:11', ' Alatise Abraham'),
(11, 7, '2,3', '1,2', 0, 700, 7620, '2018-04-10 10:37:55', ' Alatise Abraham');
...
INSERT INTO `notice_board` (`id`, `title`, `description`, `start_date`, `end_date`, `date_created`) VALUES
(1, 'Workers day', 'This is a public holiday for the government workers...', '2018-04-25 00:00:00', '2018-04-27 00:00:00', '2018-04-25 16:00:59'),
(2, 'Children', 'This is a public holiday for the government workers...', '2018-05-27 00:00:00', '2018-05-28 00:00:00', '2018-04-25 16:47:51');
...
CREATE TABLE `notification` (
  `id` int(11) NOT NULL,
  `foreign_table_id` varchar(60) DEFAULT NULL,
...
INSERT INTO `notification` (`id`, `foreign_table_id`, `description`, `status`, `date_created`) VALUES
(1, '{\"table\":\"notice_board\",\"id\":\"1\"}', 'This is a public holiday for government workers.', 'true', '2018-04-25 14:00:59'),
(2, '{\"table\":\"notice_board\",\"id\":\"2\"}', 'This is a public holiday for government workers.', 'true', '2018-04-25 14:47:51');
...
CREATE TABLE `patient` (
  ...
  `modifier` varchar(100) NOT NULL,
  `date_modified` datetime NOT NULL,
  `category` enum('in','out') NOT NULL DEFAULT 'out'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `patient` (`id`, `patient_id`, `title`, `first_name`, `middle_name`, `last_name`, `gender`, `dob`, `phone_no`, `email`, `address`, `city_address`, `state`, `lga`, `occupation`, `marital_status`, `firstname_kin`, `middle_name_kin`, `last_name_kin`, `relationship_kin`, `phone_kin`, `address_kin`, `genotype`, `blood_group`, `picture_path`, `allergy`, `blood_pressure`, `employer_name`, `weight`, `height`, `pulse`, `body_temprature`, `date_created`, `modifier`, `date_modified`, `category`) VALUES
(1, 'UCH-P20187186', 'Mr', 'Badmus', 'Bashir', 'Akintoba', 'Male', '2018-02-22', '+2348109994485', 'b.akintoba@gmail.com', 'No 3, Akobo', 'Ibadan', '31', 'Ogbomosho North', 'Programmer', 'Single', 'Badmus', 'Alabi', 'Damilare', 'Kwali', '+2348109994485', 'No 3, Akobo', 'AA', 'A+', './assets/img/patient/default.jpg', 'Egg yoke', '', NULL, NULL, NULL, NULL, NULL, '2018-02-17 17:09:23', 'admin', '2018-03-03 16:48:06', 'out'),
(2, 'UCH-P20181271', 'Mr', 'Badmus', 'Oluwaseun', 'Akintoba', 'Male', '2018-02-27', '+2348109994485', 'holynationdevelopment@gmail.com', 'Akobo', 'Ibadan', '27', 'Gbako', 'Programmer', 'Single', 'Badmus', 'Alabi', 'Damilare', 'Ibarapa East', '+2348109994485', 'Akobo', 'AS', 'B+', './assets/img/patient/default.jpg', 'Egg yoke', '', NULL, NULL, NULL, NULL, NULL, '2018-02-17 17:29:41', 'admin Alatise Abraham', '2018-03-03 16:43:27', 'out'),
(3, 'UCH-P20187887', 'Mrs', 'Ajibade', 'Abigail', 'Tolulope', 'Female', '2018-02-24', '+2348109994485', 'Abigail@gmail.com', 'No 5, Olodo', 'Ibadan', '18', 'Hadejia', 'worker', 'Married', 'Ajibade', 'Tunde', 'Samson', 'Siblings', '+2348109994485', 'No 5, Olodo', 'AS', 'B+', './assets/img/patient/default.jpg', 'Egg yoke', '', NULL, NULL, NULL, NULL, NULL, '2018-02-20 15:34:52', '', '2018-02-20 15:34:52', 'out'),
(5, 'UCH-P20185827', 'Mr', 'Alade', 'Oluwaseun', 'Temitope', 'Male', '1995-12-21', '+2347064625478', 'temitope@gmail.com', 'No 10, Oki Olodo, Ibadan.', 'Ibadan', '28', 'Ijebu Ode', 'Engineer', 'Single', 'Alade', 'Alabi', 'Tunde', 'Ijebu Ode', '+2348109994485', 'No 10, Oki Olodo, Ibadan.', 'AA', 'A+', './assets/img/patient/ehm_77966_ 5a8e838200155.jpg', 'Carbohydrate food', '', NULL, NULL, NULL, NULL, NULL, '2018-02-22 09:46:58', '', '2018-02-22 10:00:28', 'out'),
(6, 'UCH-P20188082', 'Miss', 'Babatunde', 'Adenike', 'Shade', 'Female', '2006-04-12', '+2347055448855', 'Adenike@gmail.com', 'No 24, Ewekoro', 'Ikono', '3', 'Ikono', 'Trader', 'Single', 'Babatunde', 'Oyindamola', 'Olamide', 'Siblings', '+2347055448855', 'No 24, Ewekoro', 'SS', 'B-', 'assets/img/patient/default.jpg', 'Food allergy', '', NULL, NULL, NULL, NULL, NULL, '2018-03-03 17:37:48', '', '2018-03-03 17:37:48', 'out'),
(7, 'UCH-P20184987', 'Mr', 'Omolewa', 'Adenike', 'Dasola', 'Female', '2016-03-01', '+2347055448855', 'Dasola@gmail.com', 'Ajibode,UI Ibadan', 'Ibadan', '31', 'Egbeda', 'Trader', 'Single', 'Omolewa', 'Kunle', 'Olamide', 'Siblings', '+2347055448855', 'Ajibode,UI Ibadan', 'AC', 'O+', 'assets/img/upload/patient/default.jpg', 'Carbohydrate food', '', NULL, NULL, NULL, NULL, NULL, '2018-03-07 00:35:35', '', '2018-03-07 00:35:35', 'in'),
(8, 'UCH-P20184128', 'Mr', 'Akintola', '', 'Tayo', 'Male', '1995-03-27', '+2347055448855', 'tayo@gmail.com', 'Ajibode,UI Ibadan', 'Osun', '30', 'Ife East', 'Trader', 'Single', 'Akintola', '', 'Bukky', 'Ife East', '+2347055448855', 'Ajibode,UI Ibadan', 'SS', 'A-', 'assets/img/upload/patient/ehm_4528_ 5a9f2722873db.jpg', 'Protein food', '', NULL, NULL, NULL, NULL, NULL, '2018-03-07 00:41:22', 'admin', '2018-03-07 00:54:25', 'in'),
(9, 'UCH-P20184996', 'Mrs', 'Babatunde', '', 'Steven', 'Male', '2005-03-02', '+2347055448855', 'Steven@gmail.com', 'Ikorodu, Lagos', 'Lagos', '10', 'Isoko South', 'Trader', 'Single', 'Babatunde', '', 'Olamide', 'Isoko South', '+2347055448855', 'Ikorodu, Lagos', 'AA', 'B-', 'assets/img/upload/patient/ehm_1266_ 5a9f2cd989891.jpg', 'Flour food', '', NULL, NULL, NULL, NULL, NULL, '2018-03-07 01:05:45', 'admin', '2018-04-06 17:42:41', 'in'),
(10, 'UCH-P20183904', 'Mr', 'Aba', 'Oni', 'Oni', 'Male', '2018-04-17', '0809684983848', 'bafdf@ghdfghd.com', 'lokoja', 'Ibadan', '8', 'Jere', 'Trader', 'Married', 'gcftf', 'fgf', 'fff', 'Mother', '767767676767676', 'ffff', 'AA', 'A+', 'assets/img/upload/patient/ehm_42083_ 5ac915dbc524d.jpg', 'nill', '', NULL, NULL, NULL, NULL, NULL, '2018-04-07 21:02:51', '', '0000-00-00 00:00:00', 'in');
...
CREATE TABLE `settings` (
  ...
  `mobile` varchar(14) NOT NULL DEFAULT '+2348109994485',
...
INSERT INTO `settings` (`id`, `title`, `logo`, `favicon`, `address`, `smtp_username`, `smtp_host`, `smtp_password`, `email`, `mobile`, `lock_screen`, `date_created`) VALUES
(1, 'EH-Manager', 'assets/img/upload/ehm-logo_60690_ 5ac904c0a32e4.png', '', 'No. 10, Opposite Akobo Police Station, Ibadan.', 'oalatise@technodesolutuions.com', 'smtp.technodesolutions.com', 'sincefeb2015', 'holynationdevelopment@gmail.com', '+2348109994485', '', '2018-04-25 14:06:31');
...
(10, 9, 3, '2018-03-30 00:00:00', '2018-04-27 00:00:00', 'efefefe', 28, 42000, '', 'Active', 'Active', '2018-03-10 17:35:30', '2018-03-15 17:48:43', 'Admin Alatise Abraham'),
(11, 9, 3, '2018-03-24 00:00:00', '2018-04-28 00:00:00', 'this is working', 35, 52500, '', 'Active', 'Active', '2018-03-10 18:52:47', '2018-03-15 17:42:26', 'Admin Alatise Abraham'),
...
(14, 10, 1, '2018-04-25 00:00:00', '2018-04-26 00:00:00', 'This patient is suffering from heart ache', 1, 10000, '1', 'Active', 'Active', '2018-04-24 12:19:35', '2018-04-24 12:32:51', 'Admin Alatise Abraham');
