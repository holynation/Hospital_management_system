...
//Get selected option value
    ...
    $('#select211').selectric().on('change', function () {
        ...
        // $.post('../get_medicine_jquery' , {id: id},
        //  function(result){
                ...
                hr.onreadystatechange = function(){
                    if(hr.readyState == 4 && hr.status == 200){
                        ...
                        for(i = 0; i < dataArray.length - 1;i++){
                            ...
                            html_output += '<div class="col-sm-3"><div class="box-body"><div class="form-group"><p id="select_value"><strong>itemArray[1]</strong></p></div></div><div class="col-sm-5">
                                <div class="panel">
                                    <div class="panel-heading"><h3 class="panel-title">
                                        <i class="fa ti-list" aria-hidden="true"></i> Selected Item</h3>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">itemArray[1]</div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-5 control-label" for="">
                                                Company :
                                            </label>
                                            <div class="col-sm-7"> itemArray[2]</div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-5 control-label" for="">
                                                Price :
                                            </label>
                                            <div class="col-sm-7">itemArray[3]</div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-5 control-label" for="">
                                                Current Stock :
                                            </label>
                                            <div class="col-sm-7">itemArray[4]</div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-5 control-label" for="">
                                                Quantity :
                                            </label>
                                            <div class="col-sm-7"><input type="text" name="quantityForm" value="1" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
