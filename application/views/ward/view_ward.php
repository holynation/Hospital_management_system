                                      ...
                                      <?php  } ?>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('ward/edit_ward/'. $ward->id); ?>">
                                                <button class="btn btn-primary btn-xs" data-placement="top" title="Edit Ward"><span class="fa fa-fw ti-pencil"></span> Edit</button>
                                            </a>
                                            <?php 
                                                if($ward->status == 'Active'){ ?>
                                                <button class="btn btn-icon btn-warning btn-xs" data-toggle="modal" data-target="#status_<?php echo $ward->id; ?>" data-placement="top" title="Change Status"><i class="icon fa fa-fw ti-check-box" aria-hidden="true"></i> Status</button>
                                          <?php  }else{ ?>
                                                  <button class="btn btn-icon btn-success btn-xs" data-toggle="modal" data-target="#status2_<?php echo $ward->id; ?>" data-placement="top" title="Change Status"><i class="icon fa fa-fw ti-check-box" aria-hidden="true"></i> Status</button>
                                              <?php  }
                                            ?>
