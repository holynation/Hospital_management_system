                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-condensed" id="customtable">
                                    ...
                                    <tbody>
                                    <?php foreach($data_medicine as $b){ ?>
                                       <tr>
                                           <td><?php echo $b[0]; ?></td>
                                           <td><?php echo $b[1]; ?></td>
                                           <td class="text-center"><?php echo $b[2]; ?></td>
                                           <td><input type="text" name="eachDiscount[]" id="eachDiscount_<?php echo $b[3]; ?>" class="form-control"></td>
                                           <td class="text-right" id="each_medicine_total_<?php echo $b[3]; ?>"><?php echo $b[1] * $b[2]; ?></td>
                                           <td class="text-center row_delete"></td>
                                       </tr>
                                       <input type="hidden" id="eachTotal_<?php echo $b[3]; ?>" value="<?php echo $b[1] * $b[2]; ?>" />
                                       <input type="hidden" name="eachTotal[]" id="dT_<?php echo $b[3]; ?>" value="">  

                                       <?php $item_total += ($b[1]*$b[2]);  ?>
                                       <?php //$total_discount += ($b[1]*$b[2]);  ?>
                                ...
                                <?php   }  ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="highrow text-right">
                                            <strong contenteditable><input type="text" id="itemDiscount" class="form-control" name="itemDiscount"></strong>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
