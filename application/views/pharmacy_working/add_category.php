                ...
                <div class="col-md-12">
                    <div class="panel ">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                 ...
                                 <button class="button button-rounded button-primary-flat hvr-hang">
                                     <i class="fa fa-fw ti-list"></i>  Add Category
                                </button>
                            </h3>
                        </div>
                        <?php
                        ...
                        <div class="panel-body text-center">
                            <div class="col-md-10 ">
                                <form action="<?php echo base_url('pharmacy/createCategory'); ?>" method="post" class="form-horizontal">
                                      <hr>
                                      <b class="text-center">
                                        <h3 class="panel-title"> 
                                           <i class="fa fa-fw ti-pencil"></i> Add New Category
                                        </h3>
                                      </b>
                                      <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea id="desc_info" name="desc_info" rows="4" class="form-control resize_vertical" placeholder="Category short info "></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <br><br>
