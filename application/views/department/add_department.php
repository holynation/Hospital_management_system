                ...
                <div class="col-md-12">
                    <div class="panel ">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                 ...
                                 <button class="button button-rounded button-primary-flat hvr-hang">
                                     <i class="fa fa-fw ti-list"></i>  Department
                                </button>
                            </h3>
                        </div>
                        <?php
                        ...
                        <div class="panel-body text-center">
                            <div class="col-md-10 ">
                                <form action="<?php echo base_url('department/create'); ?>" method="post" class="form-horizontal">
                                      <hr>
                                      <b class="text-center">
                                        <h3 class="panel-title"> 
                                           <i class="fa fa-fw ti-pencil"></i> Add New Department
                                        </h3>
                                      </b>
                                      <hr>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="department_info">
                                            Descripton
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-md-6">
                                            <textarea id="department_info" name="department_info" rows="4" class="form-control resize_vertical" placeholder="Department short info "></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <br><br>
