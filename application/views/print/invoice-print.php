...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Invoice #<?php echo $db_invoice_no; ?></b><br>
        <br>
        <b>Payment Due:</b> <?php echo get_date_format($db_date); ?><br>
      </div>
      <!-- /.col -->
    </div>
    <!-- /.row -->
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        ...
        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
          ...
          <br />
          Issued by: <?php echo $issued_by; ?>
        </p>
      </div>
      <!-- /.col -->
      <div class="col-xs-6">
        <p class="lead">Amount Due <?php echo get_date_format($db_date); ?></p>

        <div class="table-responsive">
          <table class="table">
            <tr>
              <th style="width:50%">Subtotal:</th>
              <td><?php echo get_local_currency() . $item_total; ?></td>
            </tr>
            <tr>
              <th>Discount</th>
              <td><?php echo get_local_currency() . $db_discount; ?></td>
            </tr>
            <?php 
                $cart_total = $item_total - $db_discount;
             ?>
            <tr>
              <th>Total:</th>
              <td><?php echo get_local_currency() . $cart_total; ?></td>
            </tr>
          </table>
        </div>
      </div>
