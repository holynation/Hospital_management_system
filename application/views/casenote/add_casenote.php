                                                    ...
                                                    <div class="col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <textarea id="description" name="p_complaint" rows="4" class="form-control resize_vertical" placeholder="Enter the information here ... ..." required="required"></textarea>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <textarea id="description" name="hp_complaint" rows="4" class="form-control resize_vertical" placeholder="Enter the information here ... ..." required="required"></textarea>
                                                                    </div>
                                                                </div>
...
<!--                                </span>-->
                    ...
                    <div class="col-md-6">
                        <div class="panel ">
                            ...
                            <div class="panel-body">
                                        <textarea id="description" name="pm_history" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel ">
                            ...
                            <div class="panel-body">
                                <div class="">
                                        <textarea id="description" name="fam_history" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                    </div>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="panel ">
                                                    ...
                                                    <div class="panel-body">
                                                        <textarea id="description" name="soc_history" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="panel ">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="">
                                                            <textarea id="description" name="drug_history" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-md-offset-3">
                                                <div class="panel ">
                                                    ...
                                                    <div class="panel-body">
                                                        <textarea id="description" name="summary_history" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="panel ">
                                                    ...
                                                    <div class="panel-body">
                                                        <textarea id="description" name="diagnosis" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..." required="required"></textarea>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="panel ">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="">
                                                            <textarea id="description" name="plan_of_mgt" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <textarea id="description" name="general_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="">
                                                                                <textarea id="description" name="systemic_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <textarea id="description" name="cardio_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="">
                                                                                <textarea id="description" name="resp_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <textarea id="description" name="abd_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="">
                                                                                <textarea id="description" name="urea_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <textarea id="description" name="cn_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="panel ">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="">
                                                                                <textarea id="description" name="musc_exm" rows="3" class="form-control resize_vertical" placeholder="Enter the information here ..."></textarea>
                                                                            </div>
