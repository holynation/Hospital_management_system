                ...
                <div class="col-lg-12">
                    <div class="panel filterable">
                        <div class="panel-heading clearfix  ">
                            <div class="panel-title pull-left">
                                 <button class="button button-rounded button-primary-flat hvr-hang">
                                     <i class="fa fa-fw ti-calendar"></i>  Create Appointment
                                </button>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="container">
                                <div class="row">
                                    <form action="" method="GET" id="searchAppointmentPatient" class="form-horizontal" role="form">
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                        $('#search_patient').on('keyup', function(){
                                            ...
                                            $.get('<?php echo base_url();?>appointment/search_patient', {search: search_data},
                                             function(result){
